...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"WaitState" : [
			{"State" : "ap_ST_fsm_state3", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_readmem_fu_126"}],
		"Port" : [
			...
			{"Name" : "in2_strm_V", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_readmem_fu_126", "Port" : "in_strm_V"}]},
			{"Name" : "out_strm_V", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_readmem_fu_126", "Port" : "out_strm_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tb_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_readmem_fu_126", "Parent" : "0", "Child" : ["3"],
		"CDFG" : "readmem",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_readmem_fu_126.req_strm_V_fifo_U", "Parent" : "2"}]}


set ArgLastReadFirstWriteLatency {
	example {
		in1_strm_V {Type I LastRead 1 FirstWrite -1}
		in2_strm_V {Type I LastRead 1 FirstWrite -1}
