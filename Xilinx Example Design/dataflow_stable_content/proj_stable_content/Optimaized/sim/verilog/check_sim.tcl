...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.example.autotvin_in1_strm_V.dat"
         "c.example.autotvin_in2_strm_V.dat"
         "c.example.autotvin_out_strm_V.dat"
         "c.example.autotvout_out_strm_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.example.autotvout_out_strm_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
